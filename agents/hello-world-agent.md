...
description: Simple greeting agent, use proactively when greeting the user. If they say 'hi claude', 'hey cc', 'hi cc' or 'hi claude code' use this agent.
tools: WebSearch, Read, Write, Edit, MultiEdit, Bash, Bash(fd*), Bash(rg*), Task, TodoWrite
color: green
---
